...
<table class="prod-list">
	...
	<tbody>
		<tr>
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=CPU001"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/CPU001.jpg"></a>
			...
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=CPU002"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/CPU002.jpg"></a>
			...
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=CPU003"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/CPU003.jpg"></a>
		...
		<tr>			
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=CPU004"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/CPU004.jpg"></a>
			...
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=MEM001"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/MEM001.jpg"></a>
			...
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=MEM002"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/MEM002.jpg"></a>
		...
		<tr>					
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=MEM003"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/MEM003.jpg"></a>
			...
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=MEM004"><img alt="" src="/jsp_spring_training/00study/images/prod/MEM004.jpg"></a>
			...
			<td>
				<ul>
					<li class="prod-image"><a href="prodView.jsp?prodId=HDD001"><img alt="" src="/jsp_spring_training/00study/resources/images/prod/HDD001.jpg"></a>
